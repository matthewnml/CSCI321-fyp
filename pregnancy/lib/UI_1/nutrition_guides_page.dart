...
class NutritionGuidesPage extends StatelessWidget {
  const NutritionGuidesPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot>(
        stream: FirebaseFirestore.instance.collection('guides').doc('1VggsIGbokU8HVjJwAbd').snapshots(),
